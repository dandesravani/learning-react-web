...
tags:
  ...
  - javasscript
  - HTML
excerpt: React allows to represent a view as data. React has ability to treat a view as a function which takes props as data and returns data as value.
---

- React allows to represent a view as data. React has ability to treat a view as a function which takes props as data and returns data
  as value.
...
JSX Element is nothing but a javascript object which consists of _tags_, _attributes_ and _children_.
